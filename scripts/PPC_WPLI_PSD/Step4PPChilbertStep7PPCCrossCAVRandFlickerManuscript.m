...
% load([SavePathLoad '7bandVRhilbertPPCresultsLocalCAVRShankColPyrCh.mat'],'PPCvrFile','NonNanVRNumFile','TSppcVRNumFile');
load([SavePathLoad '6bandVRhilbertPPCresultsCrossCAVRShankColPyrChAveSh12Notch40.mat'],'PPCvrFile','NonNanVRNumFile','TSppcVRNumFile');

% load([SavePathLoad '7bandflickerhilbertPPCresultsLocalCAShankColPyrCh.mat']);
load([SavePathLoad '6bandflickerhilbertPPCresultsCrossCAShankColPyrChAveSh12Notch40.mat']);
...
% 
% 
% %%%%%%%%%%%%Sepreate Cell,Region,VR or Flicker,PrePost chronic flicker
...
YlimCellRegion{1}=[-0.00001 0.0008;-0.001 0.008;repmat([-0.00001 0.0008],2,1);repmat([-0.00001 0.0004],3,1);];  %%CA1
YlimCellRegion{1}(4:end,:)=YlimCellRegion{1}(4:end,:)/4;

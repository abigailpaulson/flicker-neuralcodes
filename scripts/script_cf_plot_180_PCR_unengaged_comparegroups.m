...
ylim([-0.75 0.75])
xlim([0.5 2.5])
xticklabels({'unengaged', 'unengaged', 'correct', 'correct'})
yticks([-0.75 0 0.75])
ylabel('prospective coding ratio')
title({'Reward related prospective coding', 'unengaged trials'})
makefigurepretty(gcf,1)
filename = 'RRZ_PCR_pertrial_180decoding_correct_unengaged_trials_bothdays_comparegroups_allengagedtrials';
figdir = '\\ad.gatech.edu\bme\labs\singer\Abby\code\chronicflicker-ephys-prospectivecoding\results\decoding_thetaseq\';
...
filename = 'TableData_TrialData_180Decoding_ThetaSeq_Unengaged_Correct_Trials_CompareGroups.txt';

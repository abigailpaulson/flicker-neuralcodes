function cf_decoding_thetaseq_onlydecoding(dirs, params, allindex, metadata, posType, cellTypes)
%cf_decoding_thetaseq_onlydecoding
%   need a version of this that just does the theta sequence decoding and
%   saves the relevent files, nothing too fancy
%
%   based on cf_decoding_thetaseq_table_ctrlspeed.m
%
%ALP 2/7/24
...
for d = 1:size(dayindex,1)
    ...
    if ~exist(dayfilename, 'file') || rewrite.decodingfiles
        ...
        % set up spike times, spike positions, etc
        ...
        if strcmp(dType, '180')
            ...
            tmpData = [decodedData codingRatio codingRatio2];
        ...
        tmpData = [decodedData codingRatio day];
    ...
    clear appendDat decodedData testingData trainingData avgTheta tmp* sig codingRatio codingRatio2 tmpData tmpTrialData
end

function cf_decoding_thetaseq_table(dirs, params, allindex, metadata, posType, cellTypes)
...
savefilename = ['thetaseqdecoding_alldays_alltrials_230615.mat'];
...
statsdir = '\\ad.gatech.edu\bme\labs\singer\Abby\code\chronicflicker-ephys-prospectivecoding\results\LMM_R\';
filename = 'TableData_ProspectiveCoding_AfterReward_perTrial_postDataOnly.txt';
